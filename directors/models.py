...
class Genre(models.Model):
    name = models.CharField(max_length=64, help_text='Put the name of the genre')
...
class Film(models.Model):
    ...
    summary = models.TextField(max_length=100, help_text='observations')
    isbn = models.CharField('ISBN', max_length=13, help_text='ISBN is 13 characters')
